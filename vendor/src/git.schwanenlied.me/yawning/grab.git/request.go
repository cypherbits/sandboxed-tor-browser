...
type Request struct {
	...
	// directory, unless Buffer is specified.
	Filename string

	// Buffer is a bytes.Buffer where a file transfer will be stored.
	// This is to be used in lieu of Filename when downloading into memory.
	//
	// Note that regardless of server ability, downloading to memory does not
